...
import { extractTaskId } from '../lib/taskId';
        ...
        switch (pd.type) {
          ...
          case 'tool': {
            ...
            if (isWrite && inp.content) {
              ...
              // Extract task_id and output from the tool result. The
              // task_id can appear in several places depending on
              // whether the task is still running or already
              // completed; see `extractTaskId` for the priority order.
