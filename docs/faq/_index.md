...
The [MCP server](../features/mcp/) is localhost-only and exposes Factory,
routine, session inspection and creation, and file-embedding tools. Model traffic stays between OpenCode and whatever provider
