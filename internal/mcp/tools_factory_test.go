...
func TestFactoryToolActions(t *testing.T) {
	...
	if !strings.Contains(resultText(got), "submit_proposal") || !strings.Contains(resultText(got), "mutate_graph") || !strings.Contains(resultText(got), "epicId") || !strings.Contains(resultText(got), "molId") || !strings.Contains(resultText(got), "dependsOn") || !strings.Contains(resultText(got), "At least one node") || !strings.Contains(resultText(got), "Creates the next immutable proposal revision") || !strings.Contains(resultText(got), "validate_formula") || !strings.Contains(resultText(got), "preview_formula") || !strings.Contains(resultText(got), "save_formula") || !strings.Contains(resultText(got), "formula_source") || !strings.Contains(resultText(got), "custom/team") || !strings.Contains(resultText(got), "compiled") || !strings.Contains(resultText(got), "proposals") || !strings.Contains(resultText(got), "sourceHash") || !strings.Contains(resultText(got), "canonical compiled JSON") || !strings.Contains(resultText(got), "example") || !strings.Contains(resultText(got), "output_schema") || !strings.Contains(resultText(got), "action is required") || !strings.Contains(resultText(got), "unknown action") {
